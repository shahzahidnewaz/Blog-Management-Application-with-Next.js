...
![Read More](<Interface/Blog- Read More.png>)
![Registration](Interface/Registration.png)
![Log In](<Interface/Log In.png>)
![Forgot Password](<Interface/Forgot Password.png>)
![Admin Dashboard](<Interface/Admin Dashboard.png>)
![Admin Profile](<Interface/Admin Profile.png>)
![All Blogs](<Interface/All Blogs.png>)
![Users](Interface/Users.png)
![Create Blog](<Interface/Create Blog.png>)
![Change Password](<Interface/Change Password.png>)
![User Dashboard](<Interface/User Dashboard.png>)
![User Blogs](<Interface/My Blogs.png>)